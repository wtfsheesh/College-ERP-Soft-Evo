...
urlpatterns = [
    ...
    path('view-directory/', views.admin_view_lists, name='admin_view_lists'), # Admin View List(NEW)
    path('admin-list/teacher/edit/<str:teacher_id>/', views.edit_teacher, name='edit_teacher'), # Edit Teacher (NEW)
    path('admin-list/teacher/delete/<str:teacher_id>/', views.delete_teacher, name='delete_teacher'), # Delete Teacher (NEW)
    path('admin-list/student/<str:student_usn>/edit/', views.edit_student, name='edit_student'), # Edit Student (NEW)
    path('admin-list/student/<str:student_usn>/delete/', views.delete_student, name='delete_student'), # Delete Student (NEW)
]
